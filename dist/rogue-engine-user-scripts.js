...
class Animator extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    ...
    this.data = [];
    this._selected = 0;
    this.selectedOptions = this.animations.map((elem, i) => i.toString());
    this.stopped = false;
    this.stopping = false;
    this.playLabel = "Play";
    this.actions = {};
  ...
  updateConfigs() {
    ...
    this._mixer = this._mixer = new three__WEBPACK_IMPORTED_MODULE_1__.AnimationMixer(this.object3d);
    this.animations.forEach((clip, i) => {
      const action = this._mixer.clipAction(clip);
      clip.name = this.data[i].actionName;
      this.data[i].playOnce && action.setLoop(three__WEBPACK_IMPORTED_MODULE_1__.LoopOnce, 0);
  ...
  start() {
    ...
    this.animations.forEach((clip, i) => {
      ...
      if (!action)
        return;
      action.play();
      clipConfig.playOnce && action.setLoop(three__WEBPACK_IMPORTED_MODULE_1__.LoopOnce, 0);
  ...
  update() {
    if (this.stopped)
      return;
    this.mixer.update(rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Runtime.deltaTime * this.actions[this.activeAction.getClip().name].config.speed);
  }
  getAction(index) {
...
/* harmony import */ var _rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Components/CannonBody.re */ "./Assets/rogue_packages/rogue-cannon/Components/CannonBody.re.ts");
/* harmony import */ var _Animator_re__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Animator.re */ "./Assets/Components/Animator.re.ts");
/* harmony import */ var _CharacterStatus_re__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CharacterStatus.re */ "./Assets/Components/CharacterStatus.re.ts");
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
var __decorateClass = (decorators, target, key, kind) => {
...
class CharacterController extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    ...
    this.downDirection = new three__WEBPACK_IMPORTED_MODULE_1__.Vector3(0, -1, 0);
    this.inputAngularVelocity = new cannon_es__WEBPACK_IMPORTED_MODULE_5__.Vec3();
    this.inputVelocity = new cannon_es__WEBPACK_IMPORTED_MODULE_5__.Vec3();
    this.inputDirection = new three__WEBPACK_IMPORTED_MODULE_1__.Vector3();
    this.isDamaged = false;
  }
  get rigidbody() {
    if (!this._rigidbody) {
      this._rigidbody = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_2__["default"], this.object3d);
    }
    return this._rigidbody;
  }
  get animator() {
    if (!this._animator) {
      this._animator = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_Animator_re__WEBPACK_IMPORTED_MODULE_3__["default"], this.object3d);
    }
    return this._animator;
  }
  get characterStatus() {
    if (!this._characterStatus) {
      this._characterStatus = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_CharacterStatus_re__WEBPACK_IMPORTED_MODULE_4__["default"], this.object3d);
    }
  ...
  get gamepad() {
    return rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Input.gamepads[this.gamepadIndex];
  }
  update() {
    if (!this.rigidbody)
      return;
    if (!this.animator)
      return;
    if (!this.isDead && this.characterStatus.isDead)
      this.setDead();
    ...
    this.groundCheck();
    if (this.curAction && this.curAction.loop !== three__WEBPACK_IMPORTED_MODULE_1__.LoopRepeat && this.curAction !== this.getAction(actions.jump))
      return;
  ...
  getJumpInput() {
    return rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Input.keyboard.getKeyDown("Space") || this.gamepad && this.gamepad.getButtonDown(0);
  }
  translate() {
  ...
  groundCheck() {
    ...
    const targets = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponents(_rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_2__["default"]).filter((comp) => comp.object3d !== this.object3d).map((comp) => comp.object3d);
    if (targets) {
...
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], CharacterController.prototype, "gamepadIndex", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], CharacterController.prototype, "fwdSpeed", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], CharacterController.prototype, "jumpSpeed", 2);
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(CharacterController);
...
class CharacterStatus extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  applyDamage(amount) {
    ...
    this.isDamaged = true;
    rogue_engine__WEBPACK_IMPORTED_MODULE_0__.onNextFrame(() => rogue_engine__WEBPACK_IMPORTED_MODULE_0__.onNextFrame(() => this.isDamaged = false));
  }
}
__name(CharacterStatus, "CharacterStatus");
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.text()
], CharacterStatus.prototype, "tag", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], CharacterStatus.prototype, "hp", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], CharacterStatus.prototype, "curHP", 2);
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(CharacterStatus);
...
/* harmony import */ var _rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Components/CannonBody.re */ "./Assets/rogue_packages/rogue-cannon/Components/CannonBody.re.ts");
/* harmony import */ var _rogue_packages_rogue_cannon_Components_Shapes_CannonShape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Components/Shapes/CannonShape */ "./Assets/rogue_packages/rogue-cannon/Components/Shapes/CannonShape.ts");
/* harmony import */ var _CharacterController_re__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CharacterController.re */ "./Assets/Components/CharacterController.re.ts");
/* harmony import */ var _Animator_re__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Animator.re */ "./Assets/Components/Animator.re.ts");
/* harmony import */ var _rogue_packages_rogue_cannon_Lib_RogueCannon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Lib/RogueCannon */ "./Assets/rogue_packages/rogue-cannon/Lib/RogueCannon.ts");
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
var __decorateClass = (decorators, target, key, kind) => {
...
class EnemyAI extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    ...
    this.focusCannon = new cannon_es__WEBPACK_IMPORTED_MODULE_7__.Vec3();
    this.localDirection = new three__WEBPACK_IMPORTED_MODULE_1__.Vector3();
    this._attackStartPos = new three__WEBPACK_IMPORTED_MODULE_1__.Vector3();
    this.onCollide = /* @__PURE__ */ __name((event) => {
      ...
      if (shape.body !== this.rigidbody?.body)
        return;
      const otherBodyComponent = _rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_2__["default"].findByBody(event.other);
      const shapeComponent = _rogue_packages_rogue_cannon_Components_Shapes_CannonShape__WEBPACK_IMPORTED_MODULE_3__["default"].findByShape(shape);
      const characterController = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_CharacterController_re__WEBPACK_IMPORTED_MODULE_4__["default"]);
      if (shapeComponent?.name === "AttackRange" && otherBodyComponent?.object3d === characterController?.object3d) {
        const playerController = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_CharacterController_re__WEBPACK_IMPORTED_MODULE_4__["default"], otherBodyComponent?.object3d);
  ...
  get animator() {
    if (!this._animator) {
      this._animator = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.getComponent(_Animator_re__WEBPACK_IMPORTED_MODULE_5__["default"], this.object3d);
    }
    return this._animator;
  }
  get curAction() {
  ...
  engage() {
    if (!this.engaging)
      return;
    this.focus.set(this.engaging.position.x, this.object3d.position.y, this.engaging.position.z);
  ...
  follow() {
    ...
    (0,_rogue_packages_rogue_cannon_Lib_RogueCannon__WEBPACK_IMPORTED_MODULE_6__.copyThreeV3)(this.localDirection, this.focusCannon);
...
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.num()
], EnemyAI.prototype, "speed", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.checkbox()
], EnemyAI.prototype, "isAttacking", 2);
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(EnemyAI);
...
/* harmony import */ var _Animator_re__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Animator.re */ "./Assets/Components/Animator.re.ts");
/* harmony import */ var _rogue_packages_rogue_cannon_Components_Shapes_CannonShape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Components/Shapes/CannonShape */ "./Assets/rogue_packages/rogue-cannon/Components/Shapes/CannonShape.ts");
/* harmony import */ var _rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../rogue_packages/rogue-cannon/Components/CannonBody.re */ "./Assets/rogue_packages/rogue-cannon/Components/CannonBody.re.ts");
/* harmony import */ var _CharacterController_re__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CharacterController.re */ "./Assets/Components/CharacterController.re.ts");
/* harmony import */ var _CharacterStatus_re__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./CharacterStatus.re */ "./Assets/Components/CharacterStatus.re.ts");
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
var __decorateClass = (decorators, target, key, kind) => {
...
class MeleeAttack extends rogue_engine__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    ...
    this.damage = 10;
    this.isAttacking = false;
    this.localFWD = new three__WEBPACK_IMPORTED_MODULE_0__.Vector3();
    this.impulse = new cannon_es__WEBPACK_IMPORTED_MODULE_7__.Vec3();
    this.onCollisionEnter = /* @__PURE__ */ __name((event) => {
      const characterStatus = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_CharacterStatus_re__WEBPACK_IMPORTED_MODULE_6__["default"], event.other.object3d);
      if (characterStatus === this.characterStatus)
        return;
    ...
    this.worldQuaternion = new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
  }
  ...
  get animator() {
    if (!this._animator) {
      this._animator = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_Animator_re__WEBPACK_IMPORTED_MODULE_2__["default"], this.object3d);
    }
    return this._animator;
  }
  get characterController() {
    if (!this._characterController) {
      this._characterController = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_CharacterController_re__WEBPACK_IMPORTED_MODULE_5__["default"], this.object3d);
    }
    return this._characterController;
  }
  get characterStatus() {
    if (!this._characterStatus) {
      this._characterStatus = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_CharacterStatus_re__WEBPACK_IMPORTED_MODULE_6__["default"], this.object3d);
    }
    return this._characterStatus;
  }
  get rigidbody() {
    if (!this._rigidbody) {
      this._rigidbody = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_4__["default"], this.object3d);
    }
    return this._rigidbody;
  }
  get attackBody() {
    if (!this._attackBody) {
      this._attackBody = rogue_engine__WEBPACK_IMPORTED_MODULE_1__.getComponent(_rogue_packages_rogue_cannon_Components_CannonBody_re__WEBPACK_IMPORTED_MODULE_4__["default"], this.attack);
  ...
  disableColliders() {
    this.attackBody.body.shapes.forEach((shape) => {
      _rogue_packages_rogue_cannon_Components_Shapes_CannonShape__WEBPACK_IMPORTED_MODULE_3__["default"].findByShape(shape).enabled = false;
    });
  }
  enableColliders() {
    this.attackBody.body.shapes.forEach((shape) => {
      _rogue_packages_rogue_cannon_Components_Shapes_CannonShape__WEBPACK_IMPORTED_MODULE_3__["default"].findByShape(shape).enabled = true;
    });
  }
  getMeleeInput() {
    return rogue_engine__WEBPACK_IMPORTED_MODULE_1__.Input.keyboard.getKeyDown("KeyF") || this.gamepad && this.gamepad.getButtonDown(2);
  }
  start() {
...
], MeleeAttack.prototype, "attackPrefab", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_1__.props.object3d()
], MeleeAttack.prototype, "origin", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_1__.props.select()
], MeleeAttack.prototype, "selectedAction", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_1__.props.num()
], MeleeAttack.prototype, "damage", 2);
rogue_engine__WEBPACK_IMPORTED_MODULE_1__.registerComponent(MeleeAttack);
...
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.text()
], UIElement.prototype, "containerID", 2);
__decorateClass([
  rogue_engine__WEBPACK_IMPORTED_MODULE_0__.props.code("html")
], UIElement.prototype, "html", 2);
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(UIElement);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UIHealthBarsController)
/* harmony export */ });
/* harmony import */ var rogue_engine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rogue-engine */ "rogue-engine");
/* harmony import */ var rogue_engine__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(rogue_engine__WEBPACK_IMPORTED_MODULE_0__);
var __defProp = Object.defineProperty;
...
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(UIHealthBarsController);
...
class CannonConfig extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  awake() {
    _Lib_RogueCannon__WEBPACK_IMPORTED_MODULE_2__.setWorld(new cannon_es__WEBPACK_IMPORTED_MODULE_4__.World());
...
/******/ 	__webpack_require__("./Assets/Components/CharacterController.re.ts");
...
/******/ 	__webpack_require__("./Assets/Components/UIHealthBarsController.re.ts");
